...
// let mockSubInstance: { on: any; unsub: any; };
// let mockPoolInstance: { publish: any; sub: any; list: any; get: any; close: any; };
// let mockEncrypt: any;
// let mockDecrypt: any;
...
// mockEncrypt = vi.fn(async (privkeyHex, pubkeyHex, text) => `encrypted_${text}_by_${privkeyHex}_for_${pubkeyHex}`);
// mockDecrypt = vi.fn(async (privkeyHex, pubkeyHex, payload) => payload.replace(`encrypted_`, '').replace(/_by_.*_for_.*/, ''));
...
//     mockPoolInstance.publish.mockClear();
//     mockPoolInstance.sub.mockClear();
//     mockPoolInstance.list.mockClear();
//     mockPoolInstance.get.mockClear();
//     mockPoolInstance.close.mockClear();
